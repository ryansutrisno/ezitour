...
@php
    $code = $code ?? '500';
    $headline = $headline ?? 'Terjadi kesalahan';
    $description = $description ?? 'Silakan coba lagi nanti.';
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
...
<body class="mesh">
    ...
    <p class="footer-note">&copy; {{ date('Y') }} EziTour. Dibuat dengan rasa di Indonesia.</p>
</body>
</html>
