...
<div class="min-h-[calc(100vh-4rem)] grid lg:grid-cols-2">
    ...
    <div class="relative hidden lg:flex flex-col justify-between overflow-hidden bg-gradient-to-br from-blue-700 via-blue-700 to-blue-800 p-12 text-white">
        ...
        <div class="relative">
            <h2 class="font-display text-4xl font-extrabold leading-tight">Liburan impian<br>menanti di dashboardmu.</h2>
            <p class="mt-4 text-blue-100 max-w-md leading-relaxed">Masuk untuk melihat pesanan, melanjutkan pembayaran, dan mengelola petualangan berikutnya.</p>
            ...
            <ul class="mt-8 space-y-3.5">
                <li class="flex items-center gap-3 text-blue-50">
                    ...
                    <span class="text-sm">Riwayat pesanan dalam satu tempat</span>
                </li>
                <li class="flex items-center gap-3 text-blue-50">
                    <span class="flex items-center justify-center w-7 h-7 rounded-full bg-white/15"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg></span>
                    <span class="text-sm">Lanjutkan pembayaran dengan cepat</span>
                </li>
                <li class="flex items-center gap-3 text-blue-50">
                    <span class="flex items-center justify-center w-7 h-7 rounded-full bg-white/15"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg></span>
                    <span class="text-sm">E-tiket dan detail trip terorganisir</span>
                </li>
            </ul>
        </div>
        ...
        <div class="w-full max-w-md mx-auto">
            ...
            <div class="bg-white rounded-card border border-slate-100 shadow-card overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-5">
                    <h1 class="font-display text-xl font-bold text-white">Selamat datang kembali 👋</h1>
                    <p class="mt-1 text-sm text-blue-100">Masuk untuk lanjut berpetualang.</p>
                </div>
                    ...
                    <form class="space-y-5" action="{{ route('login.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="password" name="password" type="password" autocomplete="current-password" required placeholder="Masukkan password" class="block w-full pl-11 pr-11 py-3 rounded-input border-2 border-slate-200 bg-slate-50 text-slate-800 placeholder-slate-400 focus:border-blue-500 focus:ring-blue-500 focus:outline-none focus:bg-white transition-colors sm:text-sm @error('password') border-red-400 bg-red-50 @enderror">
            ...
            <p class="mt-6 text-center text-sm text-slate-600">
                Belum punya akun?
                <a href="{{ route('register') }}" class="font-semibold text-blue-600 hover:text-blue-700">Daftar gratis</a>
            </p>
        </div>
    </div>
</div>
