...
@section('title', __('front.faq_title') . ' - EziTour')

@section('seo')
    <x-seo
        :title="__('front.faq_title')"
        :description="__('front.faq_seo_description')"
        type="website"
    />
@endsection
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-slate-50">
        <div aria-hidden="true" class="pointer-events-none absolute inset-0">
            ...
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,rgb(15_23_42/0.05)_1px,transparent_0)] [background-size:22px 22px]"></div>
        </div>
    ...
    <section class="py-16 sm:py-20 bg-white">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($faqs->isEmpty())
                <p class="text-center text-slate-500 py-12">{{ __('front.faq_empty') }}</p>
            @endif
        </div>
    </section>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative overflow-hidden rounded-card bg-gradient-to-br from-blue-700 via-blue-700 to-blue-800 px-8 py-12 sm:px-12 sm:py-14 shadow-hover text-center">
                ...
                <div class="relative max-w-2xl mx-auto">
                    <h2 class="font-display text-2xl sm:text-3xl font-extrabold tracking-tight text-white">{{ __('front.faq_cta_title') }}</h2>
                    <p class="mt-3 text-blue-100 leading-relaxed">{{ __('front.faq_cta_body') }}</p>
