...
return [
    ...
    | aturan ukuran. Silakan sesuaikan pesan-pesan ini.
    |
    */
    ...
    | menggunakan konvensi "attribute.rule". Ini mempermudah menentukan
    | pesan khusus untuk aturan atribut tertentu.
    |
    */
